...
require 'active_interaction/filters/complex_filter'
...
require 'active_interaction/filters/dir_filter'
require 'active_interaction/filters/enumerator_filter'
...
require 'active_interaction/filters/io_filter'
require 'active_interaction/filters/model_filter'
require 'active_interaction/filters/range_filter'
require 'active_interaction/filters/rational_filter'
require 'active_interaction/filters/regexp_filter'
